	...
	factory: (require) => {
		...
		*/
		...
		function Loaded({ injected, renderSlot }) {
			...
			*/
			...
			const configured = state.rows.filter((row) => row.configured).sort((left, right) => Number(right.entry.provider === "deepseek-official") - Number(left.entry.provider === "deepseek-official"));
			...
			const claudeEnabled = customEnabled && state.namespaces.has(CLAUDE_PROVIDER_SETTINGS_NS);
			...
			const switchLocked = catalogBusy || customBusy || claudeBusy;
			const draft = (() => {
					...
					(0, react_jsx_runtime.jsx)("div", {
						...
						children: addOpen ? (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								mounted("claude") && piAi !== void 0 ? (0, react_jsx_runtime.jsx)("div", {
									id: `${addId}-claude-panel`,
									...bothOffered ? {
										role: "tabpanel",
										"aria-labelledby": `${addId}-claude`
									} : {},
									hidden: mode !== "claude",
									className: ModelsSection_module_css_default["addPanel"],
									children: (0, react_jsx_runtime.jsx)(CustomProviderCard, {
		...
		*/
		...
		const en = {
			...
			addMode: "How to add",
			addCatalog: "Third-party providers",
			addCustom: "Custom API",
